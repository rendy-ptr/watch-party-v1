...
export default function ContentPage() {
  ...
  const joinRoom = async () => {
    ...
    try {
      ...
      const snapshot = await get(child(roomRef, `rooms/${slug}`))
    ...
    <AnimatedBackground>
      <div className="w-full max-w-2xl mx-auto px-6 py-20">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-indigo-400 font-mono mb-4 tracking-wider">
            WATCH PARTY
          </h1>
          <p className="text-xl text-gray-300 font-light tracking-wide opacity-80">
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center">
            <span className="px-6 text-slate-400 font-bold">OR</span>
          </div>
        </div>
