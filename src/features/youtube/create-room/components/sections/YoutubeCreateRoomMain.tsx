...
const YoutubeCreateRoomMain = () => {
  ...
  return (
    <div className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-6 md:p-8 mb-8 shadow-2xl hover:bg-white/10 transition-all duration-300 space-y-4">
      ...
      <button
        onClick={() => createRoomHandler(youtubeUrl, roomName)}
        disabled={isLoading}
